...
// Model string passed to `claude --model`. Accepts aliases ("opus", "sonnet",
// "haiku") or full model names ("claude-opus-4-6", etc.).
...
const MODEL_MAP: Record<string, ClaudeModel> = {
  ...
  // Bare aliases — use pinned defaults so behavior is deterministic.
...
export function extractModel(model: string): ClaudeModel {
  ...
  // Default to Opus 4.6 (pinned — Claude Max subscription).
